                                        ...
                                        <?php foreach ($vpn as $data) { ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-info btn-sm detail-btn" data-nama="<?= $data->nama ?>" data-password="<?= $data->password ?>">
...
<script>
    ...
    $(document).on("click", ".detail-btn", function() {
        ...
        var sentence = '/interface l2tp-client add connect-to=vpn.labkom.us name=' + nama + ' password="' + password + '" user="' + nama + '" disable=no';
